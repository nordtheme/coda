...
<p align="center">
  ...
  <a href="https://panic.com/coda">
    <img src="https://img.shields.io/static/v1.svg?style=flat-square&logo=coda&logoColor=eceff4&label=Coda%20Version%20Compatibility&message=2.5+&colorA=4c566a&colorB=88c0d0" />
  </a>
</p>
...
Implemented the main SeeStyle- and SSS theme files [`Nord.seestyle`](https://github.com/nordtheme/coda/blob/develop/src/Nord.seestyle) and [`Nord.sss`](https://github.com/nordtheme/coda/blob/develop/src/Nord.sss). (@svengreb, #1, a4e1f614)
...
Detailed information about supported languages/modes and install instructions can be found in the [README](https://github.com/nordtheme/coda/blob/develop/readme.md#installation).
